...
FILESCORE = "\Python_Games\TetrisWithHighScores\scores.txt"
...
def update_score(nscore):
    ...
    # filename = os.path.join(scriptpath, 'scores.txt')
...
def draw_window(surface, grid, score=0, last_score=0):
    ...
    # Last Score
    label = font.render('High Socre: ' + last_score, 1, (255, 255, 255))
